  ...
  theme: {
    extend: {
      ...
      keyframes: {
        ...
        'text-glow-anim': {
          '0%, 100%': {
            textShadow: '0 0 5px hsl(var(--primary-foreground)), 0 0 10px hsl(var(--primary-foreground)), 0 0 20px hsl(var(--primary)), 0 0 30px hsl(var(--primary)), 0 0 40px hsl(var(--primary))'
          },
          '50%': {
