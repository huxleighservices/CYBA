...
function AvatarDisplay({ avatarConfig, size = 128 }: { avatarConfig?: AvatarConfig; size?: number }) {
  ...
  return (
    <div className="relative bg-muted/30 rounded-lg" style={{ width: size, height: size }}>
       ...
       <Image src={getOption('shoes').url} alt={getOption('shoes').name} fill className="object-contain" style={{ zIndex: 20 }} data-ai-hint={getOption('shoes').hint} />
       <Image src={getOption('pants').url} alt={getOption('pants').name} fill className="object-contain" style={{ zIndex: 30 }} data-ai-hint={getOption('pants').hint} />
